...
public class frame1 extends JFrame implements ActionListener{
	...
	frame1(){
		...
		Bcpu.setText("Number of jobs allocated to nodelist (CPU)");
		Bgpu.setText("Number of jobs allocated to nodelist (GPU)");
		Berror.setText("Number of errors by month");
		Bpartition.setText("Number of jobs by partitions");
		Busec.setText("Average time taken to submit the job");
		Bjob.setText("Number of jobs completed by month");
		BAveExeTime.setText("Average Execution Time of Jobs");
		BTimeLimitMonth.setText("Number of jobs exceeded time limit");
		Bkilljob.setText("Number of jobs killed by months");
		Bexit0.setText("Number of jobs completed with exit status 0");
		BjobAllo.setText("Number of jobs allocated by month");
		BjobC.setText("Number of jobs submitted by month");
		BerrorU.setText("Number of error caused by user");
